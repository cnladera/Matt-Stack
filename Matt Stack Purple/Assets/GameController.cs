...
public class GameController : MonoBehaviour
{
    ...
    void NewBlock()
    {
        if (lastCube != null)
        {
            ...
            currentCube.transform.localScale = new Vector3(lastCube.transform.localScale.x - Mathf.Abs(
                currentCube.transform.position.x - lastCube.transform.position.x), lastCube.transform.localScale.y,
        ...
        currentCube.GetComponent<MeshRenderer>().material.SetColor("_Color", Color.HSVToRGB((Level / 100f)
            % 1f, 1f, 1f));
        Level++;
